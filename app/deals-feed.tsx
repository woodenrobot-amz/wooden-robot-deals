            ...
            return (
              <article key={deal.id} className="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-lg shadow-black/20">
                <div className="relative">
                  ...
                  {isRecent(deal.created_at) && <span className="absolute left-3 top-3 rounded-full bg-amber-400 px-2.5 py-1 text-xs font-black uppercase tracking-wide text-zinc-950 shadow">Recently added</span>}
